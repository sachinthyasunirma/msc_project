...
import {
  createHotelRateRestriction,
  listHotelRateRestrictions,
...
export async function GET(request: Request, context: RouteContext) {
  try {
    ...
    const result = await listHotelRateRestrictions(
      ratePlanId,
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const result = await createHotelRateRestriction(ratePlanId, payload, request.headers);
